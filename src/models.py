...
#   timestamp: 2025-07-30T22:42:51+00:00
...
class CoinbaseDataProviderSettings(BaseModel):
    id: Annotated[Id7, Field(description='Id of the module.')]
...
class BinanceDataProviderSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the module.')]
...
class OandaSettings(BaseModel):
    id: Annotated[Id23, Field(description='Id of the module.')]
...
class TradeStationSettings(BaseModel):
    id: Annotated[Id25, Field(description='Id of the module.')]
...
class TastytradeSettings(BaseModel):
    id: Annotated[Id26, Field(description='Id of the module.')]
...
class CharlesSchwabSettings(BaseModel):
    id: Annotated[Id27, Field(description='Id of the module.')]
...
class TradierSettings(BaseModel):
    id: Annotated[Optional[str], Field(description='ID of the module.')] = None
    tradier_account_id: Annotated[
        Optional[str],
...
class WolverineSettings(BaseModel):
    id: Annotated[Id24, Field(description='Id of the module.')]
...
class TerminalLinkSettings(BaseModel):
    id: Annotated[Id28, Field(description='Id of the module.')]
...
class RBIBrokerageSettings(BaseModel):
    id: Annotated[Id29, Field(description='Id of the module.')]
