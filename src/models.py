...
class CodeCompletionRequest(BaseModel):
    ...
    responseSizeLimit: Annotated[
        Optional[int], Field(description='Maximum size of the responses.', examples=10)
    ] = None
...
class CodeCompletionResponse(BaseModel):
    ...
    payloadType: Annotated[
        Optional[str],
        Field(
            description='Type of the payload, e.g. StringArray.', examples='StringArray'
        ),
    ] = None
...
class CreateCompileRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id we wish to compile.', examples=23456789)
    ]
...
class Collaborator(BaseModel):
    ...
    email: Annotated[
        Optional[str],
        Field(description='The registered email of the user.', examples='abc@123.com'),
    ] = None
    name: Annotated[
...
class CreateCollaboratorRequest(BaseModel):
    ...
    collaboratorUserId: Annotated[
        str,
        Field(
            description='User Id of the collaborator we want to add.', examples='mia-ai'
        ),
    ]
    ...
    collaborationWrite: Annotated[
        Optional[bool],
        Field(description='Gives the right to edit the code.', examples=False),
    ] = None
...
class UpdateCollaboratorRequest(BaseModel):
    ...
    write: Annotated[
        Optional[bool],
        Field(description='Gives the right to edit the code.', examples=True),
    ] = None
...
class CompileResponse(BaseModel):
    compileId: Annotated[
        Optional[str],
        Field(
            description='Compile Id for a sucessful build.', examples='c0edc6-49048b'
        ),
    ] = None
    state: Annotated[
    ...
    projectId: Annotated[
        Optional[int],
        Field(description='Project Id we sent for compile.', examples=23456789),
    ] = None
    signature: Annotated[
...
class CreateBacktestRequest(BaseModel):
    ...
    backtestName: Annotated[
        Optional[str],
        Field(
            description='Optional. Name for the new backtest.', examples='New Backtest'
        ),
    ] = None
...
class CreateLiveAlgorithmRequest(BaseModel):
    ...
    compileId: Annotated[
        str, Field(description='Compile Id.', examples='c0edc6-49048b')
    ]
    nodeId: Annotated[
...
class GetObjectStoreURLRequest(BaseModel):
    ...
    jobId: Annotated[
        str,
        Field(description='Job ID for getting a download URL for.', examples='string'),
    ]
...
class GetObjectStorePropertiesRequest(BaseModel):
    ...
    key: Annotated[str, Field(description='Key to the Object Store.', examples='key1')]
...
class Library(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id of the library project.', examples=23456789)
    ]
...
class ListObjectStoreRequest(BaseModel):
    ...
    path: Annotated[
        Optional[str],
        Field(
            description='Optional. Path to the Object Store files.', examples='/folder1'
        ),
    ] = None
...
class ObjectStoreBinaryFile(BaseModel):
    organizationId: Annotated[
        str,
        Field(
            description='Orgainization ID.', examples='5cad178b20a1d52567b534553413b691'
        ),
    ]
    key: Annotated[
        str,
...
class OptimizationTarget(BaseModel):
    ...
    extremum: Annotated[
        Optional[str],
        Field(
            description='Defines the direction of optimization.', examples='max or min'
        ),
    ] = None
    targetValue: Annotated[
        Optional[float],
...
class ProjectNodesResponse(BaseModel):
    nodes: Annotated[Optional[Any], Field(description='List of project nodes.')] = None
...
class ReadBacktestChartRequest(BaseModel):
    ...
    name: Annotated[
        str, Field(description='The requested chart name.', examples='Strategy Equity')
    ]
    count: Annotated[
...
class RuntimeStatistics(BaseModel):
    ...
    Unrealized: Annotated[
        Optional[str], Field(description='Unrealized profit/loss.', examples='$100.00')
    ] = None
    Volume: Annotated[
        Optional[str],
...
class UpdateProjectRequest(BaseModel):
    ...
    name: Annotated[
        str,
        Field(description='The new name for the project.', examples='New Project Name'),
    ]
    description: Annotated[
        Optional[str],
        Field(
...
class SearchRequest(BaseModel):
    language: Annotated[
        Language,
        Field(
            description='Programming language of the content to search.', examples='Py'
        ),
    ]
    criteria: Annotated[
        List[SearchCriteria],
...
class CreateOptimizationRequest(BaseModel):
    ...
    compileId: Annotated[
        str, Field(description='Optimization compile ID.', examples='c0edc6-49048b')
    ]
    parameters: Annotated[
    ...
    parallelNodes: Annotated[
        int, Field(description='Number of parallel nodes for optimization.', examples=4)
    ]
