...
#   timestamp: 2025-07-29T20:06:24+00:00
...
class BybitDataProviderSettings(BaseModel):
    id: Annotated[Id20, Field(description='Id of the data provider.')]
...
class OandaSettings(BaseModel):
    id: Annotated[Id22, Field(description='Id of the brokerage or data provider.')]
...
class TradeStationSettings(BaseModel):
    id: Annotated[Id24, Field(description='Id of the brokerage and data provider.')]
...
class Insight(BaseModel):
    ...
    type: Annotated[Optional[Type], Field(description='Gets the type of insight.')] = (
        None
    )
    reference: Annotated[
        Optional[float],
...
class RBIBrokerageSettings(BaseModel):
    id: Annotated[Id26, Field(description='Id of the brokerage.')]
...
class CharlesSchwabSettings(BaseModel):
    id: Annotated[Id27, Field(description='Id of the brokerage or data provider.')]
...
class BybitBrokerageSettings(BaseModel):
    id: Annotated[Id20, Field(description='Id of the brokerage.')]
    bybit_api_key: Annotated[
        str, Field(alias='bybit-api-key', description='Your Bybit API key.')
    ]
    bybit_api_secret: Annotated[
...
class WolverineSettings(BaseModel):
    id: Annotated[Id23, Field(description='Id of the brokerage.')]
