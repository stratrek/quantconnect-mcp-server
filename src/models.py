...
#   timestamp: 2025-07-30T17:50:37+00:00
...
class QuantConnectDataProviderSettings(BaseModel):
    id: Annotated[Id, Field(description='Id of the data provider.')]
...
class InteractiveBrokersBrokerageSettings(BaseModel):
    id: Annotated[Id2, Field(description='Id of the brokerage.')]
...
class InteractiveBrokersDataProviderSettings(BaseModel):
    id: Annotated[Id2, Field(description='Id of the data provider.')]
    ib_user_name: Annotated[
        str,
        Field(alias='ib-user-name', description='Your Interactive Brokers username'),
    ]
    ...
    ib_password: Annotated[
        str, Field(alias='ib-password', description='Your Interactive Brokers password')
    ]
    ib_weekly_restart_utc_time: Annotated[
        str,
        Field(
    ...
    ib_enable_delayed_streaming_data: Annotated[
        Optional[bool],
        Field(
            alias='ib-enable-delayed-streaming-data',
            description="Whether delayed data may be used when your algorithm subscribes to a security you don't have a market data subscription for. Use `false`.",
        ),
    ] = None
...
class TradierBrokerageSettings(BaseModel):
    id: Annotated[Id4, Field(description='Id of the brokerage.')]
...
class TradierDataProviderSettings(BaseModel):
    id: Annotated[Id4, Field(description='Id of the data provider.')]
    tradier_account_id: Annotated[
        str, Field(alias='tradier-account-id', description='Your Tradier account id')
    ]
    tradier_access_token: Annotated[
    ...
    tradier_environment: Annotated[
        ...
        Field(
            alias='tradier-environment',
            description='Whether the developer sandbox should be used. Use `live`.',
        ),
    ]
...
class BitfinexSettings(BaseModel):
    id: Annotated[Id6, Field(description='Id of the brokerage or data provider.')]
...
class CoinbaseDataProviderSettings(BaseModel):
    id: Annotated[Id7, Field(description='Id of the data provider.')]
    ...
    coinbase_url: Annotated[
        Optional[str],
        Field(alias='coinbase-url', examples=['wss://advanced-trade-ws.coinbase.com']),
    ] = None
    coinbase_rest_api: Annotated[
        Optional[str],
        Field(alias='coinbase-rest-api', examples=['https://api.coinbase.com']),
    ] = None
...
class BinanceExchangeName4(Enum):
    Binance = 'Binance'


class BinanceDataProviderSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the data provider.')]
    binance_exchange_name: Annotated[
        BinanceExchangeName4,
    ...
    binance_api_url: Annotated[
        ...
        Field(
            ...
            examples=['https://api.binance.com', 'https://testnet.binance.vision'],
        ),
    ] = None
...
class BinanceExchangeName5(Enum):
    BinanceUS = 'BinanceUS'


class BinanceUSDataProviderSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the data provider.')]
    binance_exchange_name: Annotated[
        BinanceExchangeName5,
        Field(alias='binance-exchange-name', description='Binance exchange name.'),
    ]
    ...
    binanceus_api_url: Annotated[
        ...
        Field(
            ...
            examples=['https://api.binance.us/', 'https://testnet.binance.vision'],
        ),
    ] = None
...
class BinanceExchangeName6(Enum):
    Binance_USDM_Futures = 'Binance-USDM-Futures'


class BinanceUSDMFuturesDataProviderSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the data provider.')]
    binance_exchange_name: Annotated[
        BinanceExchangeName6,
        Field(alias='binance-exchange-name', description='Binance exchange name.'),
    ]
    binance_api_key: Annotated[
        str, Field(alias='binance-api-key', description='Your Binance API key')
    ...
    binance_fapi_url: Annotated[
        ...
        Field(
            ...
            examples=['https://fapi.binance.com', 'https://testnet.binancefuture.com'],
        ),
    ] = None
...
class BinanceExchangeName7(Enum):
    Binance_COIN_Futures = 'Binance-COIN-Futures'


class BinanceCOINFuturesDataProviderSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the data provider.')]
    binance_exchange_name: Annotated[
        BinanceExchangeName7,
        Field(alias='binance-exchange-name', description='Binance exchange name.'),
    ]
    binance_api_key: Annotated[
        str, Field(alias='binance-api-key', description='Your Binance API key')
    ...
    binance_dapi_url: Annotated[
        ...
        Field(
            ...
            examples=['https://dapi.binance.com', 'https://testnet.binancefuture.com'],
        ),
    ] = None
...
class TradingTechnologiesBrokerageSettings(BaseModel):
    id: Annotated[Id17, Field(description='Id of the brokerage.')]
...
class KrakenSettings(BaseModel):
    id: Annotated[Id18, Field(description='Id of the brokerage or data provider.')]
...
class AlpacaBrokerageSettings(BaseModel):
    id: Annotated[Id19, Field(description='Id of the brokerage.')]
    alpaca_api_key: Annotated[
        Optional[str],
        Field(
            alias='alpaca-api-key',
            description='Your Alpaca API key. Required if you omit the alpaca-access-token.',
        ),
    ] = None
    alpaca_api_secret: Annotated[
        Optional[str],
        Field(
            alias='alpaca-api-secret',
            description='Your Alpaca API secret. Required if you omit the alpaca-access-token.',
        ),
    ] = None
    ...
    alpaca_environment: Annotated[
        Optional[AlpacaEnvironment],
        Field(
            alias='alpaca-environment',
            description='The environment to run in. Required if you provide an alpaca-access-token.',
        ),
    ] = None


class AlpacaDataProviderSettings(BaseModel):
    id: Annotated[Id19, Field(description='Id of the data provider.')]
    alpaca_api_key: Annotated[
...
class PolygonDataProviderSettings(BaseModel):
    id: Annotated[Id21, Field(description='Id of the data provider.')]
...
class BybitDataProviderSettings(BaseModel):
    id: Annotated[Id22, Field(description='Id of the data provider.')]
    ...
    bybit_api_url: Annotated[
        ...
        Field(
            alias='bybit-api-url',
            examples=['https://api.bybit.com', 'https://api-testnet.bybit.com'],
        ),
    ] = None
    bybit_websocket_url: Annotated[
        ...
        Field(
            ...
            examples=['wss://stream.bybit.com', 'wss://stream-testnet.bybit.com'],
        ),
    ] = None
...
class OandaSettings(BaseModel):
    id: Annotated[Id24, Field(description='Id of the brokerage or data provider.')]
...
class TradeStationSettings(BaseModel):
    id: Annotated[Id26, Field(description='Id of the brokerage and data provider.')]
...
class TastytradeSettings(BaseModel):
    id: Annotated[Id27, Field(description='Id of the brokerage.')]
...
class RBIBrokerageSettings(BaseModel):
    id: Annotated[Id28, Field(description='Id of the brokerage.')]
...
class CharlesSchwabSettings(BaseModel):
    id: Annotated[Id29, Field(description='Id of the brokerage or data provider.')]
...
class TerminalLinkSettings(BaseModel):
    id: Annotated[Id30, Field(description='Id of the brokerage.')]
...
class QuantConnectBrokerageSettings(BaseModel):
    id: Annotated[Id, Field(description='Id of the brokerage.')]
    holdings: Annotated[
        Optional[List[BrokerageHolding]],
        Field(description='List of holdings for the brokerage.'),
    ] = None
...
class CoinbaseBrokerageSettings(BaseModel):
    id: Annotated[Id7, Field(description='Id of the brokerage.')]
    coinbase_api_name: Annotated[
        str,
        Field(
            alias='coinbase-api-name',
...
class BinanceBrokerageSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the brokerage.')]
    binance_exchange_name: Annotated[
        BinanceExchangeName,
        Field(alias='binance-exchange-name', description='Binance exchange name.'),
    ]
...
class BinanceUSBrokerageSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the brokerage.')]
    binance_exchange_name: Annotated[
...
class BinanceUSDMFuturesBrokerageSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the brokerage.')]
    binance_exchange_name: Annotated[
...
class BinanceCOINFuturesBrokerageSettings(BaseModel):
    id: Annotated[Id9, Field(description='Id of the brokerage.')]
    binance_exchange_name: Annotated[
...
class BybitBrokerageSettings(BaseModel):
    id: Annotated[Id22, Field(description='Id of the brokerage.')]
    bybit_api_key: Annotated[
        str, Field(alias='bybit-api-key', description='Your Bybit API key.')
    ]
    bybit_api_secret: Annotated[
...
class WolverineSettings(BaseModel):
    id: Annotated[Id25, Field(description='Id of the brokerage.')]
