...
class BacktestInitResponse(BaseModel):
    state: Annotated[
        Optional[str],
        Field(description='State of the backtest (e.g. Error, End).', example='End'),
    ] = None
    version: Annotated[
        Optional[str], Field(description='Version of the response.', example=2.0)
    ] = None
    payload: Annotated[
        Optional[str],
    ...
    payloadType: Annotated[
        Optional[str],
        Field(description='Type of the payload, e.g. String.', example='String'),
    ] = None
...
class CodeCompletionRequest(BaseModel):
    language: Annotated[
        Language,
        Field(
            description='Programming language for the code completion.', example='Py'
        ),
    ]
    sentence: Annotated[
        str,
        Field(
            description='Sentence to complete.', example='self.add_equity(\\"AAPL\\"'
        ),
    ]
    responseSizeLimit: Annotated[
        Optional[int], Field(description='Maximum size of the responses.', example=10)
    ] = None


class CodeCompletionResponse(BaseModel):
    state: Annotated[
        Optional[str], Field(description='State of the code completion.', example='End')
    ] = None
    version: Annotated[
        Optional[str], Field(description='Version of the response.', example=2.0)
    ] = None
    ...
    payloadType: Annotated[
        Optional[str],
        Field(
            description='Type of the payload, e.g. StringArray.', example='StringArray'
        ),
    ] = None
...
class PEP8ConvertResponse(BaseModel):
    state: Annotated[
        Optional[str], Field(description='State of PEP8 conversion.', example='End')
    ] = None
    version: Annotated[
        Optional[str], Field(description='Version of the response.', example=2.0)
    ] = None
    ...
    payloadType: Annotated[
        Optional[str],
        Field(
            description='Type of the payload, e.g. StringDict.', example='StringDict'
        ),
    ] = None
...
class SyntaxCheckResponse(BaseModel):
    state: Annotated[
        Optional[str], Field(description='State of the syntax check.', example='End')
    ] = None
    version: Annotated[
        Optional[str], Field(description='Version of the response.', example=2.0)
    ] = None
...
class SearchCriteria(BaseModel):
    input: Annotated[
        Optional[str], Field(description='Input for the search.', example='option')
    ] = None
    type: Annotated[
        Optional[str], Field(description='Type of the search criteria.', example='Docs')
    ] = None
    count: Annotated[
        Optional[int], Field(description='Number of results to return.', example=1)
    ] = None
...
class SearchRetrieval(BaseModel):
    ...
    score: Annotated[
        Optional[float],
        Field(description='Relevance score of the search result.', example=0.320344448),
    ] = None
    content: Annotated[
        Optional[str], Field(description='Content of the search result.')
    ] = None
    type: Annotated[
        Optional[float], Field(description='Type of the search result.', example=2)
    ] = None
...
class BacktestReportRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Id of the project to read.', example=23456789)
    ]
...
class BaseLiveAlgorithmSettings(BaseModel):
    ...
    user: Annotated[
        Optional[str],
        Field(description='Username associated with brokerage.', example=''),
    ] = None
    password: Annotated[
        Optional[str],
        Field(description='Password associated with brokerage.', example=''),
    ] = None
    ...
    account: Annotated[
        Optional[str],
        Field(description='Account of the associated brokerage.', example=''),
    ] = None
...
class Cash(BaseModel):
    ...
    currencySymbol: Annotated[
        Optional[str], Field(description='The symbol of the currency, such as $.')
    ] = None
...
class CreateCompileRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id we wish to compile.', example=23456789)
    ]
...
class Collaborator(BaseModel):
    ...
    liveControl: Annotated[
        Optional[bool], Field(description='Indicate if the user have live control.')
    ] = None
    ...
    email: Annotated[
        Optional[str],
        Field(description='The registered email of the user.', example='abc@123.com'),
    ] = None
    name: Annotated[
...
class CreateCollaboratorRequest(BaseModel):
    ...
    collaboratorUserId: Annotated[
        str,
        Field(
            description='User Id of the collaborator we want to add.', example='mia-ai'
        ),
    ]
    ...
    collaborationWrite: Annotated[
        Optional[bool],
        Field(description='Gives the right to edit the code.', example=False),
    ] = None
...
class UpdateCollaboratorRequest(BaseModel):
    ...
    write: Annotated[
        Optional[bool],
        Field(description='Gives the right to edit the code.', example=True),
    ] = None
...
class CompileFile(BaseModel):
    projectId: Annotated[
        Optional[int], Field(description='Project id.', example=23456789)
    ] = None
    open: Annotated[
        Optional[bool], Field(description='Indicates if the file is being opened.')
    ] = None
    isLibrary: Annotated[
        Optional[bool],
        Field(description='Indicates if the file is coming from a library project.'),
    ] = None
    collaborationId: Annotated[
        Optional[str], Field(description='Collaboration id.')
    ] = None
...
class CompileResponse(BaseModel):
    compileId: Annotated[
        Optional[str],
        Field(description='Compile Id for a sucessful build.', example='c0edc6-49048b'),
    ] = None
    state: Annotated[
        Optional[State], Field(description='True on successful compile.')
    ] = None
    projectId: Annotated[
        Optional[int],
        Field(description='Project Id we sent for compile.', example=23456789),
    ] = None
    signature: Annotated[
...
class CreateBacktestRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id we sent for compile.', example=23456789)
    ]
    compileId: Annotated[
        str,
        Field(
    ...
    backtestName: Annotated[
        Optional[str],
        Field(description='Name for the new backtest.', example='New Backtest'),
    ] = None
    parameters: Annotated[
        Optional[Dict[str, Union[str, float, int]]],
        Field(
            description='Parameters to use during the backtest. Parameter values must be string, number, or integer type.',
            example={'ema_fast': 10, 'ema_slow': 100},
        ),
    ] = None
...
class CreateLiveAlgorithmRequest(BaseModel):
    ...
    projectId: Annotated[int, Field(description='Project Id.', example=23456789)]
    compileId: Annotated[str, Field(description='Compile Id.', example='c0edc6-49048b')]
    nodeId: Annotated[
...
class CreateProjectFileRequest(BaseModel):
    projectId: Annotated[
        int,
        Field(description='Project Id to which the file belongs.', example=23456789),
    ]
    name: Annotated[
        str, Field(description='The name of the new file.', example='main.py')
    ]
    content: Annotated[
        str,
        Field(
...
class DeleteProjectRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Id of the project to delete.', example=23456789)
    ]
...
class DeleteObjectStoreRequest(BaseModel):
    ...
    key: Annotated[
        str, Field(description='Key to the Object Store file', example='key1')
    ]
...
class Estimate(BaseModel):
    ...
    time: Annotated[
        Optional[int], Field(description='Estimate time in seconds.', example=60)
    ] = None
    balance: Annotated[
        Optional[int], Field(description='Estimate balance in QCC.', example=10)
    ] = None
...
class GetObjectStoreJobIdRequest(BaseModel):
    ...
    keys: Annotated[
        List[str],
        Field(
            description='Keys to the Object Store files.', example='["key1", "key2"]'
        ),
    ]
...
class GetObjectStoreURLRequest(BaseModel):
    ...
    jobId: Annotated[
        str,
        Field(description='Job ID for getting a download URL for.', example='string'),
    ]
...
class GetObjectStorePropertiesRequest(BaseModel):
    ...
    key: Annotated[str, Field(description='Key to the Object Store.', example='key1')]
...
class ObjectStoreProperties(BaseModel):
    ...
    size: Annotated[
        Optional[float], Field(description='Object Store file size.', example=24)
    ] = None
    md5: Annotated[
        Optional[str],
...
class Library(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id of the library project.', example=23456789)
    ]
...
class LiveAlgorithm(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id for the live instance.', example=23456789)
    ]
    deployId: Annotated[
        Optional[str],
        Field(
...
class ListObjectStoreRequest(BaseModel):
    ...
    path: Annotated[
        Optional[str],
        Field(description='Path to the Object Store files.', example='/folder1'),
    ] = None
...
class LoadingChartResponse(BaseModel):
    ...
    status: Annotated[
        Optional[str],
        Field(description='Status of the chart generation process.', example='loading'),
    ] = None
    success: Annotated[
        Optional[bool], Field(description='Indicate if the API request was successful.')
    ] = None
...
class ObjectStoreBinaryFile(BaseModel):
    organizationId: Annotated[
        str,
        Field(
            description='Orgainization ID.', example='5cad178b20a1d52567b534553413b691'
        ),
    ]
    key: Annotated[
        str,
...
class ObjectStoreSummary(BaseModel):
    key: Annotated[
        Optional[str], Field(description='Object Store key.', example='Mia/Test')
    ] = None
    ...
    mime: Annotated[
        Optional[str], Field(description='MIME type.', example='application/json')
    ] = None
    folder: Annotated[
        Optional[bool], Field(description='True if it is a folder, false otherwise.')
    ] = None
    size: Annotated[
        Optional[float], Field(description='Object Store file size.', example=13)
    ] = None
...
class OptimizationConstraint(BaseModel):
    ...
    operator: Annotated[
        Optional[str],
        Field(description='The target comparison operation', example='greater'),
    ] = None
    targetValue: Annotated[
        Optional[float],
        Field(description='The value of the property we want to track', example=1),
    ] = None
...
class OptimizationParameter(BaseModel):
    name: Annotated[
        Optional[str],
        Field(description='Name of optimization parameter.', example='rsi_period'),
    ] = None
    min: Annotated[
        Optional[float],
        Field(
    ...
    step: Annotated[
        Optional[float], Field(description='Movement, should be positive', example=1)
    ] = None
    minStep: Annotated[
        Optional[float],
        Field(
...
class OptimizationTarget(BaseModel):
    ...
    extremum: Annotated[
        Optional[str],
        Field(
            description='Defines the direction of optimization.', example='max or min'
        ),
    ] = None
    targetValue: Annotated[
        Optional[float],
...
class OptimizationBacktest(BaseModel):
    ...
    parameterSet: Annotated[
        ...
        Field(
            description='Parameters used during the backtest.',
            example={'ema_fast': '10', 'ema_slow': '100'},
        ),
    ] = None
    equity: Annotated[
...
class Type3(Enum):
    QuantConnect_Orders_TimeInForces_DayTimeInForce = (
...
class Type4(Enum):
    QuantConnect_Orders_TimeInForces_GoodTilDateTimeInForce = (
...
class GoodTilDateTimeInForce(BaseModel):
    ...
    Expiry: Annotated[
        datetime,
        Field(
            description='Expiry date and time in ISO 8601 format.',
            example='2026-06-19T12:00:00',
        ),
    ]
...
class ParameterSet(BaseModel):
    ...
    value: Annotated[Optional[float], Field(description='Value of parameter.')] = None
...
class ProjectFile(BaseModel):
    ...
    projectId: Annotated[int, Field(description='ID of the project.', example=23456789)]
...
class ReadFilesRequest(BaseModel):
    ...
    name: Annotated[
        Optional[str],
        Field(description='The name of the file that will be read.', example='file.py'),
    ] = None
...
class ReadLiveLogsRequest(BaseModel):
    format: Annotated[
        Optional[Any], Field(description='Format of the log results', example='json')
    ] = None
    projectId: Annotated[
        int,
        Field(
            description='Project Id of the live running algorithm.', example=23456789
        ),
    ]
    algorithmId: Annotated[
        str,
...
class ReadProjectNodesRequest(BaseModel):
    projectId: Annotated[
        str,
        Field(
            description='Id of the project to which the nodes refer.', example=23456789
        ),
    ]
...
class ReadBacktestRequest(BaseModel):
    ...
    chart: Annotated[
        Optional[str],
        Field(
            description='If provided, the API will return the backtests charts.',
...
class ReadBacktestChartRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project ID of the request.', example=12345678)
    ]
    backtestId: Annotated[
        str,
        Field(
    ...
    name: Annotated[
        str, Field(description='The requested chart name.', example='Strategy Equity')
    ]
    count: Annotated[
        int, Field(description='The number of data points to request.', example=100)
    ]
    start: Annotated[
        int,
        Field(
            description='If provided, the Utc start seconds timestamp of the request.',
            example=1717801200,
        ),
    ]
    end: Annotated[
        int,
        Field(
            description='If provided, the Utc end seconds timestamp of the request.',
            example=1743462000,
        ),
    ]
...
class ReadLiveChartRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project ID of the request.', example=23456789)
    ]
    name: Annotated[
        str, Field(description='The requested chart name.', example='Strategy Equity')
    ]
...
class RestResponse(BaseModel):
    success: Annotated[
        bool, Field(description='Indicate if the API request was successful.')
    ]
    errors: Annotated[
        Optional[List[str]], Field(description='List of errors with the API call.')
    ] = None
...
class RuntimeStatistics(BaseModel):
    Equity: Annotated[
        Optional[str], Field(description='Total portfolio value.', example='$100.00')
    ] = None
    Fees: Annotated[
        Optional[str], Field(description='Transaction fee.', example='-$100.00')
    ] = None
    Holdings: Annotated[
        Optional[str],
        Field(description='Equity value of security holdings.', example='$100.00'),
    ] = None
    Net_Profit: Annotated[
        Optional[str],
        Field(alias='Net Profit', description='Net profit.', example='$100.00'),
    ] = None
    ...
    Return: Annotated[Optional[str], Field(description='Return.', example='50.00%')] = (
        None
    )
    Unrealized: Annotated[
        Optional[str], Field(description='Unrealized profit/loss.', example='$100.00')
    ] = None
    Volume: Annotated[
        Optional[str], Field(description='Total transaction volume.', example='$100.00')
    ] = None
...
class OptimizationRuntimeStatistics(BaseModel):
    Completed: Annotated[
        Optional[str],
        Field(description='The number of backtests that completed.', example='4'),
    ] = None
    Failed: Annotated[
        Optional[str],
        Field(description='The number of backtests that failed.', example='0'),
    ] = None
    Running: Annotated[
        Optional[str],
        Field(description='The number of backtests currently running.', example='2'),
    ] = None
    In_Queue: Annotated[
        Optional[str],
        Field(
            alias='In Queue',
            description='The number of backtests in queue to run.',
            example='2',
        ),
    ] = None
    Average_Length: Annotated[
        ...
        Field(
            ...
            description='The average backtest duration.',
            example='00:00:06',
        ),
    ] = None
    Total_Runtime: Annotated[
        ...
        Field(
            alias='Total Runtime',
            description='The total duration to run all the backtests.',
            example='00:00:24',
        ),
    ] = None
    Total: Annotated[
        Optional[str],
        Field(
            description='The total number of backtests in the optimization job.',
            example='8',
        ),
    ] = None
    Consumed: Annotated[
        Optional[str],
        Field(
            description='The amount of QuantConnect Credit consumed to run the optimization job up to its current state.',
            example='0.68 QCC',
        ),
    ] = None
...
class UpdateFileNameRequest(BaseModel):
    ...
    oldFileName: Annotated[
        str, Field(description='The current name of the file.', example='file1.py')
    ]
    newName: Annotated[
        str, Field(description='The new name for the file.', example='file2.py')
    ]
...
class UpdateProjectRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='The Id of the project to update.', example=23456789)
    ]
    name: Annotated[
        Optional[str],
        Field(description='The new name for the project.', example='New Project Name'),
    ] = None
    description: Annotated[
        Optional[str],
        Field(
...
class UpdateProjectNodesRequest(BaseModel):
    projectId: Annotated[
        int, Field(description='Project Id to which the nodes refer.', example=23456789)
    ]
    nodes: Annotated[
        Optional[List[str]], Field(description='List of node Id to update.')
    ] = None
...
class BasicFilesRequest(BaseModel):
    language: Annotated[
        Language, Field(description='Programming language.', example='Py')
    ]
    files: Annotated[
        List[File],
        Field(
...
class SearchRequest(BaseModel):
    language: Annotated[
        Language,
        Field(
            description='Programming language of the content to search.', example='Py'
        ),
    ]
    criteria: Annotated[
        List[SearchCriteria],
...
class SearchResponse(BaseModel):
    state: Annotated[
        Optional[str], Field(description='State of the search.', example='End')
    ] = None
    version: Annotated[
        Optional[str], Field(description='Version of the response.', example=2.0)
    ] = None
    ...
    messageId: Annotated[
        Optional[int], Field(description='ID of the message.', example=0)
    ] = None
...
class BacktestResult(BaseModel):
    ...
    parameterSet: Annotated[
        Optional[ParameterSet], Field(description='Parameters used in the backtest.')
    ] = None
...
class Chart(BaseModel):
    ...
    series: Annotated[
        Optional[Series], Field(description='List of Series Objects for this Chart.')
    ] = None
...
class CreateOptimizationRequest(BaseModel):
    ...
    targetValue: Annotated[
        float, Field(description='Optimization target value.', example=1)
    ]
    strategy: Annotated[
        str,
        Field(
    ...
    compileId: Annotated[
        str, Field(description='Optimization compile ID.', example='c0edc6-49048b')
    ]
    parameters: Annotated[
    ...
    estimatedCost: Annotated[
        float, Field(description='Estimated cost for optimization.', example=10)
    ]
    nodeType: Annotated[
        NodeType, Field(description='Optimization node type.', example='O2-8')
    ]
    parallelNodes: Annotated[
        int, Field(description='Number of parallel nodes for optimization.', example=4)
    ]
...
class CreateOptimizationResponse(BaseModel):
    optimizationId: Annotated[
        Optional[str],
        Field(
            description='Optimization ID.', example='O-401d3d40b5a0e9f8c46c954a303f3ddd'
        ),
    ] = None
    projectId: Annotated[
        Optional[int],
    ...
    nodeType: Annotated[
        Optional[NodeType], Field(description='Optimization node type.', example='O2-8')
    ] = None
    criterion: Annotated[
...
class Holding(BaseModel):
    ...
    currencySymbol: Annotated[
        Optional[str],
        Field(description='The currency symbol of the holding.', example='$'),
    ] = None
    averagePrice: Annotated[
        Optional[float],
        Field(
...
class LiveAlgorithmResults(BaseModel):
    message: Annotated[
        Optional[str], Field(description='Error message.', example='message')
    ] = None
    status: Annotated[
        Optional[str],
        Field(
...
class ListObjectStoreResponse(BaseModel):
    path: Annotated[
        Optional[str],
        Field(description='Path to the files in the Object Store.', example='Mia'),
    ] = None
    objects: Annotated[
...
class Optimization(BaseModel):
    ...
    nodeType: Annotated[
        Optional[NodeType3],
        Field(description='Optimization node type.', example='O2-8'),
    ] = None
    parallelNodes: Annotated[
        Optional[int],
        Field(description='Number of parallel nodes for optimization.', example=4),
    ] = None
    criterion: Annotated[
        Optional[OptimizationTarget],
        Field(description='Optimization statistical target.'),
    ...
    runtimeStatistics: Annotated[
        ...
        Field(
            description='The runtime banner/updating statistics for the optimization.'
        ),
    ] = None
    constraints: Annotated[
        Optional[List[OptimizationConstraint]],
...
class OrderProperties(BaseModel):
    timeInForce: Union[
        GoodTilCanceledTimeInForce, DayTimeInForce, GoodTilDateTimeInForce
    ]
...
class ProjectNodesResponse(BaseModel):
    ...
    autoSelectNode: Annotated[
        Optional[bool],
        Field(description='Indicate if a node is automatically selected.'),
    ] = None
    success: Annotated[
        Optional[bool], Field(description='Indicate if the API request was successful.')
    ] = None
